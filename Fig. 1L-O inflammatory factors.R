...
library(Rmisc)
library(readxl)
TNF_α <- read_excel("TNF_alpha.xlsx", sheet = "Sheet2")
...
library(ggpubr)
library(Rmisc)
IL_1β <- read_excel("IL_1beta.xlsx", sheet = "Sheet2")
ordercolors<-c("#B2B2B2","#F4B9D9","#AAD7C8","#619CD9")
Process_comparisons <- list(c("control", "lps"))  ####
IL_1β
...
library(Rmisc)
library(readxl)
IL_6 <- read_excel("IL_6.xlsx", sheet = "Sheet2")
